...
export async function fetchVideosFromBFF(query: string, useMockOnError: boolean = false): Promise<{ title: string; url: string }[]> {
    try {
...
export function loadMockVideos(query: string): { title: string; url: string }[] {
    try {
